...
import numpy as np
import pandas as pd
from SI_Toolkit.TF.TF_Functions.TF2Numpy import create_rnn_instance_numpy


# RNN_FULL_NAME = 'GRU-6IN-64H1-64H2-5OUT-0' # DT = 0.1s for this net
RNN_FULL_NAME = 'Dense-9IN-16H1-16H2-7OUT-0' # DT = 0.1s for this net
# RNN_PATH = './save_tf/long_3_55/'
RNN_PATH = './save_tf/'
# RNN_PATH = './controllers/nets/mpc_on_rnn_tf/'
PREDICTION_FEATURES_NAMES = ['x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7']
