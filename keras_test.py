...
if TRAIN_NEW_MODEL:
    ...
    model = keras.models.load_model('keras_model.km')
...
x_test = [
    [48.52940997965647,14.184236643335186,0.16841573274034935,7.076115033187338,0.17417732213439957,0.43026457546845215,0.07354705438652182,0.34065824691511365,0.1916452940425778]
]
